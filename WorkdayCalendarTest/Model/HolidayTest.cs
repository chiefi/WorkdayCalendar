...
{
    [TestMethod]
    public void Holiday_Overkill_Test()
    {
        // Arrange
        var holiday = new Holiday { Year = 2004, Month = 5, Day = 17 };

        // Assert
        Assert.AreEqual(2004, holiday.Year);
        Assert.AreEqual(5, holiday.Month);
        Assert.AreEqual(17, holiday.Day);
    }

    [TestMethod]
    public void Holiday_Compare_Holiday()
    {
        // Arrange
        var holiday = new Holiday { Year = 2004, Month = 5, Day = 17 };

        var holiday1 = new Holiday { Year = 2004, Month = 5, Day = 17 };
        var holiday2 = new Holiday { Year = 2005, Month = 5, Day = 17 };
        var holiday3 = new Holiday { Year = 2004, Month = 6, Day = 17 };
        var holiday4 = new Holiday { Year = 2004, Month = 5, Day = 18 };

        // Act
        var result1 = holiday.Equals(holiday1);
        var result2 = holiday.Equals(holiday2);
        var result3 = holiday.Equals(holiday3);
        var result4 = holiday.Equals(holiday4);
    ...
    [TestMethod]
    public void Holiday_Compare_DateTime()
    {
        // Arrange
        var holiday = new Holiday { Year = 2004, Month = 5, Day = 17 };
